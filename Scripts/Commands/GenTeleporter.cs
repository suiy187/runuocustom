	...
	public class GenTeleporter
	{
		...
		public class TeleportersCreator
		{
            ...
            public void CreateTeleportersMap5(Map map)
            {
                ...
                //SA to Under
                CreateTeleporter(519, 919, 39, 1125, 1075, -117, map, Map.TerMur, false);
                CreateTeleporter(520, 919, 39, 1125, 1075, -117, map, Map.TerMur, false);
                CreateTeleporter(521, 919, 39, 1126, 1075, -117, map, Map.TerMur, false);
                CreateTeleporter(522, 919, 36, 1126, 1075, -117, map, Map.TerMur, false);
                ...
                CreateTeleporter(841, 272, 30, 434, 152, 0, map, Map.TerMur, false);
                CreateTeleporter(841, 273, 30, 434, 153, 0, map, Map.TerMur, false);

                CreateTeleporter(841, 287, 30, 433, 167, 0, map, Map.TerMur, false);
                CreateTeleporter(843, 286, 22, 433, 166, 0, map, Map.TerMur, false);

                //Dragons Lair Entrance two to First Dragons Lair Entrance
                CreateTeleporter(442, 152, -38, 850, 272, -11, map, Map.TerMur, false);
                CreateTeleporter(442, 153, -38, 850, 273, -11, map, Map.TerMur, false);

                CreateTeleporter(442, 166, -38, 850, 286, -11, map, Map.TerMur, false);
                CreateTeleporter(442, 167, -38, 850, 287, -11, map, Map.TerMur, false);
