...
namespace Server.Engines.Craft
{
    ...
    public class DefTailoring : CraftSystem
    {
        ...
        public override void InitCraftList()
        {
            ...
            if (Core.SA)
            {
                AddCraft(typeof(GargishSash), 1015283, 1115388, 4.1, 29.1, typeof(Cloth), 1044286, 4, 1044287);
                AddCraft(typeof(GargishApron), 1015283, 1099568, 20.7, 45.7, typeof(Cloth), 1044286, 6, 1044287);
            }
            ...
            if (Core.SA)
            {
                ...
                AddCraft(typeof(GargishClothWingArmor), 1111748, 1115393, 66.3, 91.3, typeof(Cloth), 1044462, 12, 1044463);
            }
            #endregion
