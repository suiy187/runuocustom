...
{					
	...
	{							
		...
		public UntanglingTheWebQuest() : base()
		{			
        ...
        {
            public AcidCreaturesObjective( Type creature, string name, int amount ) : base( creature, name, amount )
            {
            }
	...
	public class Vernix : MondainQuester
	{
		...
		[Constructable]
		public Vernix() : base( "Vernix", "the Green Goblin King" )
		{			
		}
