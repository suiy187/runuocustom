...
{	
	public class Zosilem : MondainQuester
	{
		...
		[Constructable]
		public Zosilem() : base("Zosilem", "the Alchemist")
		{	
		}
		...
		public Zosilem( Serial serial ) : base( serial )
		{
		}
                ...
                if (item1 is PotionKeg)
                {
                  ...
                  if( m_Pot1.m_Type == PotionEffect.RefreshTotal )
                  {
                  ...
                  else if( m_Pot1.m_Type == PotionEffect.PoisonGreater )
                  {
                       from.SendMessage("OHHHH YESSS !!!");
