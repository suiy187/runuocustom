...
namespace Server.Mobiles
{
    public class TikitaviRenowned : BaseRenowned
	{
        ...
        public override Type[] UniqueSAList { get { return new Type[] { typeof(BasiliskHideBreastplate) }; } }

        public override Type[] SharedSAList {get{return new Type[] {typeof( LegacyOfDespair ),typeof( MysticsGarb )}; } }
