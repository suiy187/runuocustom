...
namespace Server.Misc
{
	public class DataPath
	{
		 ...
		 */
        private static string CustomPath = @"C:\Program Files\Electronics Arts\Ultima Online Classic";
		...
		public static void Configure()
		{
			...
			string pathSA = GetPath( @"Electronic Arts\EA Games\Ultima Online Classic", "InstallDir" );
