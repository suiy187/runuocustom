...
namespace Server.Mobiles
{
    public class FireDaemonRenowned : BaseRenowned
	{
        ...
        public override Type[] UniqueSAList{ get { return new Type[] {typeof( ResonantStaffofEnlightenment), typeof( MantleOfTheFallen)};}}
        public override Type[] SharedSAList{ get { return new Type[] {typeof( LegacyOfDespair)}; } }
