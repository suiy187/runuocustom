...
namespace Server
{
	...
	{	
        ...
        private static bool m_MedusaLair;
        ...
        public static bool MedusaLair { get { return m_MedusaLair; } set { m_MedusaLair = value; } }
		...
		public static void LoadSettings()
		{
			...
			try
			{
                ...
                ReadNode( root, "MedusLair", ref m_MedusaLair );
		...
		public static void SaveSetings()
		{
			...
			{	
                ...
                UpdateNode( root, "MedusaLair", m_MedusaLair );
	...
	{	
		public MondainsLegacyGump() : base( 50, 50 )
		{
            ...
            AddButton( 20, 310, MondainsLegacy.MedusaLair ? 0x939 : 0x938, MondainsLegacy.MedusaLair ? 0x939 : 0x938, 10, GumpButtonType.Reply, 0);
            ...
            AddLabel( 45, 306, 0x226, "MedusaLair");
		...
		public override void OnResponse( NetState sender, RelayInfo info )
		{
			switch ( info.ButtonID )
			{
                ...
                case 11: MondainsLegacy.MedusaLair = !MondainsLegacy.MedusaLair; break;
