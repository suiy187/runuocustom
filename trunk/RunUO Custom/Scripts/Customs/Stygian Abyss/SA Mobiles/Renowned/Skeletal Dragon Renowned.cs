...
namespace Server.Mobiles
{
	...
	public class SkeletalDragonRenowned : BaseCreature
	{
		[Constructable]
		public SkeletalDragonRenowned () : base( AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
		...
		public SkeletalDragonRenowned( Serial serial ) : base( serial )
		{
		}
